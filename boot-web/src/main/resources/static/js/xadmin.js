  ...
  Xadmin.prototype.del_tab = function (id) {
	...
	Xadmin.prototype.add_lay_tab = function(title,url,id) {
		element.tabAdd('xbs_tab', {
	       title: title 
	        ,content: '<iframe tab-id="'+id+'" frameborder="0" src="toPage?url='+url+'" scrolling="yes" class="x-iframe"></iframe>'
	        ,id: id
	    })
	}
	/**
	...
	Xadmin.prototype.myopen = function (title,url,w,h,full) {
		if (title == null || title == '') {
	        var title=false;
	    };
	    if (url == null || url == '') {
